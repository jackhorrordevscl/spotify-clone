          ...
          <View style={styles.header}>
            ...
            <View style={styles.playlistInfo}>
              ...
              <View style={styles.cover}>
                {playlist.coverUrl
                  ? <Image source={{ uri: playlist.coverUrl }}
              ...
              <View style={styles.meta}>
                ...
                {playlist.songs.length > 0 && (
                  <TouchableOpacity
                    ...
                    activeOpacity={0.8}
                  >
                    <Ionicons name="play" size={16} color="#080d12"
                              style={{ marginLeft: 2 }} />
...
const styles = StyleSheet.create({
  ...
  meta:       { flex: 1, gap: 4 },
  metaType:   { fontSize: 10, fontWeight: '600', letterSpacing: 1.5,
                color: colors.textMuted, textTransform: 'uppercase' },
  metaTitle:  { fontSize: 22, fontWeight: '700', color: colors.textPrimary, marginTop: 2 },
